var unmarshall = require("../converter").unmarshall;

describe("converter unmarshall", () => {
  it("should unmarshall a simple streamed image", () => {
    var streamImage = {
      foo: { BOOL: true },
      bar: { N: "32.23" },
      baz: { S: "foo bar" },
    ...
    expect(unmarshall(streamImage)).toEqual(model);
  });

  it("should unmarshall a complex streamed image", () => {
    var streamImage = {
      country: {
        S: "United States",
      },
